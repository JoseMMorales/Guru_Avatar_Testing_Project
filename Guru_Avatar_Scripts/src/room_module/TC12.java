...
public class TC12 {
	...
	public static void main(String[] args) throws Exception {
		...
		if(Switch.isDisplayed() && Switch.isEnabled()) {
			
			Switch.click();
		}
		
		if(Goto.isEnabled() && Goto.isDisplayed()) {
		...
		WebElement Edit = driver.findElement(By.xpath("//*[@id=\"ja-content-main\"]/div[2]/div[2]/div/div/a"));
